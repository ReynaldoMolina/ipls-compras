...
import { FormSelectOptions, OrdenDetalleTable } from '@/types/types';
import { ActionsBarDetalle } from './action-bar/action-bar-detalle';

interface DataTableProps<TData extends OrdenDetalleTable, TValue, TModal> {
...
export function DataTableSolicitud<
  TData extends OrdenDetalleTable,
  TValue,
  TModal,
>({
  columns,
