...
ALTER TABLE "ordenes" ADD CONSTRAINT "ordenes_id_proveedor_proveedores_id_fk" FOREIGN KEY ("id_proveedor") REFERENCES "public"."proveedores"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ordenes" ADD CONSTRAINT "ordenes_id_estado_ordenes_estados_id_fk" FOREIGN KEY ("id_estado") REFERENCES "public"."ordenes_estados"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
